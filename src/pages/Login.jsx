        ...
        <div className="flex w-full justify-center">
          ...
          >
            <div className="mb-8 flex flex-col gap-3 text-center">
              ...
              <p className={clsx("text-sm", textSubtle)}>
                {selectedCopy.helper}
              </p>
            </div>
              ...
              {roleOptions.map((role) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={clsx("text-xs", textFaint)}>
                      {role.description}
                    </span>
                  </button>
                );
            ...
            <div
              className={clsx("mt-8 space-y-4 text-center text-sm", textSubtle)}
            >
              <p>
                Need an account?{" "}
                <Link
